"use strict";
(self["webpackChunkbio_medical"] = self["webpackChunkbio_medical"] || []).push([[4704],{
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "equals": () => (/* binding */ o),
/* harmony export */   "pointEquals": () => (/* binding */ r)
/* harmony export */ });
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "equals": () => (/* reexport safe */ _dehydratedFeatureComparison_js__WEBPACK_IMPORTED_MODULE_11__.equals),
/* harmony export */   "DehydratedFeatureClass": () => (/* binding */ j),
/* harmony export */   "DehydratedFeatureSetClass": () => (/* binding */ N),
/* harmony export */   "computeAABB": () => (/* binding */ T),
/* harmony export */   "computeAABR": () => (/* binding */ J),
/* harmony export */   "estimateGeometryObjectSize": () => (/* binding */ R),
/* harmony export */   "estimateSize": () => (/* binding */ A),
/* harmony export */   "expandAABB": () => (/* binding */ B),
/* harmony export */   "expandAABR": () => (/* binding */ L),
/* harmony export */   "fromFeatureSetJSON": () => (/* binding */ z),
/* harmony export */   "fromJSONGeometry": () => (/* binding */ I),
/* harmony export */   "getObjectId": () => (/* binding */ O),
/* harmony export */   "hasGeometry": () => (/* binding */ M),
/* harmony export */   "hasVertices": () => (/* binding */ S),
/* harmony export */   "isFeatureGeometry": () => (/* binding */ k),
/* harmony export */   "makeDehydratedPoint": () => (/* binding */ v),
/* harmony export */   "numVertices": () => (/* binding */ w)
/* harmony export */ });
/* harmony import */ var _core_byteSizeEstimations_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../core/byteSizeEstimations.js */ 48154);
...
/* harmony import */ var _core_typedArrayUtil_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../core/typedArrayUtil.js */ 65218);
/* harmony import */ var _core_uid_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../core/uid.js */ 30145);
/* harmony import */ var _geometry_SpatialReference_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../../geometry/SpatialReference.js */ 96583);
...
/* harmony import */ var _geometry_support_quantizationUtils_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../../geometry/support/quantizationUtils.js */ 91409);
/* harmony import */ var _geometry_support_typeUtils_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../../geometry/support/typeUtils.js */ 557);
/* harmony import */ var _support_Field_js__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../support/Field.js */ 66536);
/* harmony import */ var _dehydratedFeatureComparison_js__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./dehydratedFeatureComparison.js */ 15305);
/*
All material copyright ESRI, All Rights Reserved, unless otherwise specified.
See https://js.arcgis.com/4.22/esri/copyright.txt for details.
*/
class j{constructor(e,t,s){this.uid=e,this.geometry=t,this.attributes=s,this.visible=!0,this.objectId=null,this.centroid=null}}function M(e){return (0,_core_maybe_js__WEBPACK_IMPORTED_MODULE_2__.isSome)(e.geometry)}function k(e){return (0,_geometry_support_typeUtils_js__WEBPACK_IMPORTED_MODULE_9__.isFeatureGeometryType)(e.type)}class N{constructor(){this.exceededTransferLimit=!1,this.features=[],this.fields=[],this.hasM=!1,this.hasZ=!1,this.geometryType=null,this.objectIdFieldName=null,this.globalIdFieldName=null,this.geometryProperties=null,this.geohashFieldName=null,this.spatialReference=null,this.transform=null}}function z(e){const s=_geometry_support_typeUtils_js__WEBPACK_IMPORTED_MODULE_9__.featureGeometryTypeKebabDictionary.fromJSON(e.geometryType),r=_geometry_SpatialReference_js__WEBPACK_IMPORTED_MODULE_5__.default.fromJSON(e.spatialReference),n=e.transform,a=e.features.map((o=>{const a=F(o,s,r,e.objectIdFieldName),i=a.geometry;if((0,_core_maybe_js__WEBPACK_IMPORTED_MODULE_2__.isSome)(i)&&n)switch(i.type){case"point":a.geometry=(0,_geometry_support_quantizationUtils_js__WEBPACK_IMPORTED_MODULE_8__.unquantizePoint)(n,i,i,i.hasZ,i.hasM);break;case"multipoint":a.geometry=(0,_geometry_support_quantizationUtils_js__WEBPACK_IMPORTED_MODULE_8__.unquantizeMultipoint)(n,i,i,i.hasZ,i.hasM);break;case"polygon":a.geometry=(0,_geometry_support_quantizationUtils_js__WEBPACK_IMPORTED_MODULE_8__.unquantizePolygon)(n,i,i,i.hasZ,i.hasM);break;case"polyline":a.geometry=(0,_geometry_support_quantizationUtils_js__WEBPACK_IMPORTED_MODULE_8__.unquantizePolyline)(n,i,i,i.hasZ,i.hasM);break;case"extent":case"mesh":a.geometry=i}return a}));return{geometryType:s,features:a,spatialReference:r,fields:e.fields?e.fields.map((e=>_support_Field_js__WEBPACK_IMPORTED_MODULE_10__.default.fromJSON(e))):null,objectIdFieldName:e.objectIdFieldName,globalIdFieldName:e.globalIdFieldName,geohashFieldName:e.geohashFieldName,geometryProperties:e.geometryProperties,hasZ:e.hasZ,hasM:e.hasM,exceededTransferLimit:e.exceededTransferLimit,transform:null}}function F(e,t,s,r){return{uid:(0,_core_uid_js__WEBPACK_IMPORTED_MODULE_4__.generateUID)(),objectId:r&&e.attributes?e.attributes[r]:null,attributes:e.attributes,geometry:I(e.geometry,t,s),visible:!0}}function I(e,t,r){if((0,_core_maybe_js__WEBPACK_IMPORTED_MODULE_2__.isNone)(e))return null;switch(t){case"point":{const t=e;return{x:t.x,y:t.y,z:t.z,m:t.m,hasZ:null!=t.z,hasM:null!=t.m,type:"point",spatialReference:r}}case"polyline":{const t=e;return{paths:t.paths,hasZ:!!t.hasZ,hasM:!!t.hasM,type:"polyline",spatialReference:r}}case"polygon":{const t=e;return{rings:t.rings,hasZ:!!t.hasZ,hasM:!!t.hasM,type:"polygon",spatialReference:r}}case"multipoint":{const t=e;return{points:t.points,hasZ:!!t.hasZ,hasM:!!t.hasM,type:"multipoint",spatialReference:r}}}}function v(e,t,s,r){return{x:e,y:t,z:s,hasZ:null!=s,hasM:!1,spatialReference:r,type:"point"}}function R(e){if((0,_core_maybe_js__WEBPACK_IMPORTED_MODULE_2__.isNone)(e))return 0;let t=32;switch(e.type){case"point":t+=42;break;case"polyline":case"polygon":{let s=0;const r=2+(e.hasZ?1:0)+(e.hasM?1:0),n="polyline"===e.type?e.paths:e.rings;for(const e of n)s+=e.length;t+=8*s*r+64,t+=128*s,t+=34,t+=32*(n.length+1);break}case"multipoint":{const s=2+(e.hasZ?1:0)+(e.hasM?1:0),r=e.points.length;t+=8*r*s+64,t+=128*r,t+=34,t+=32;break}case"extent":t+=98,e.hasM&&(t+=32),e.hasZ&&(t+=32);break;case"mesh":t+=(0,_core_typedArrayUtil_js__WEBPACK_IMPORTED_MODULE_3__.estimateSize)(e.vertexAttributes.position),t+=(0,_core_typedArrayUtil_js__WEBPACK_IMPORTED_MODULE_3__.estimateSize)(e.vertexAttributes.normal),t+=(0,_core_typedArrayUtil_js__WEBPACK_IMPORTED_MODULE_3__.estimateSize)(e.vertexAttributes.uv),t+=(0,_core_typedArrayUtil_js__WEBPACK_IMPORTED_MODULE_3__.estimateSize)(e.vertexAttributes.tangent)}return t}function A(t){let s=32;return s+=(0,_core_byteSizeEstimations_js__WEBPACK_IMPORTED_MODULE_0__.estimateAttributesObjectSize)(t.attributes),s+=3,s+=8+R(t.geometry),s}function w(e){if((0,_core_maybe_js__WEBPACK_IMPORTED_MODULE_2__.isNone)(e))return 0;switch(e.type){case"point":return 1;case"polyline":{let t=0;for(const s of e.paths)t+=s.length;return t}case"polygon":{let t=0;for(const s of e.rings)t+=s.length;return t}case"multipoint":return e.points.length;case"extent":return 2;case"mesh":{const t=e.vertexAttributes&&e.vertexAttributes.position;return t?t.length/3:0}default:return}}function S(e){if((0,_core_maybe_js__WEBPACK_IMPORTED_MODULE_2__.isNone)(e))return!1;switch(e.type){case"extent":case"point":return!0;case"polyline":for(const t of e.paths)if(t.length>0)return!0;return!1;case"polygon":for(const t of e.rings)if(t.length>0)return!0;return!1;case"multipoint":return e.points.length>0;case"mesh":return!e.loaded||e.vertexAttributes.position.length>0}}function T(e,t){switch((0,_geometry_support_aaBoundingBox_js__WEBPACK_IMPORTED_MODULE_6__.empty)(t),"mesh"===e.type&&(e=e.extent),e.type){case"point":t[0]=t[3]=e.x,t[1]=t[4]=e.y,e.hasZ&&(t[2]=t[5]=e.z);break;case"polyline":for(let s=0;s<e.paths.length;s++)(0,_geometry_support_aaBoundingBox_js__WEBPACK_IMPORTED_MODULE_6__.expandWithNestedArray)(t,e.paths[s],e.hasZ);break;case"polygon":for(let s=0;s<e.rings.length;s++)(0,_geometry_support_aaBoundingBox_js__WEBPACK_IMPORTED_MODULE_6__.expandWithNestedArray)(t,e.rings[s],e.hasZ);break;case"multipoint":(0,_geometry_support_aaBoundingBox_js__WEBPACK_IMPORTED_MODULE_6__.expandWithNestedArray)(t,e.points,e.hasZ);break;case"extent":t[0]=e.xmin,t[1]=e.ymin,t[3]=e.xmax,t[4]=e.ymax,null!=e.zmin&&(t[2]=e.zmin),null!=e.zmax&&(t[5]=e.zmax)}}function B(e,t){T(e,P),(0,_geometry_support_aaBoundingBox_js__WEBPACK_IMPORTED_MODULE_6__.expandWithAABB)(t,P)}function J(e,t){switch((0,_geometry_support_aaBoundingRect_js__WEBPACK_IMPORTED_MODULE_7__.empty)(t),"mesh"===e.type&&(e=e.extent),e.type){case"point":t[0]=t[2]=e.x,t[1]=t[3]=e.y;break;case"polyline":for(let s=0;s<e.paths.length;s++)(0,_geometry_support_aaBoundingRect_js__WEBPACK_IMPORTED_MODULE_7__.expandWithNestedArray)(t,e.paths[s]);break;case"polygon":for(let s=0;s<e.rings.length;s++)(0,_geometry_support_aaBoundingRect_js__WEBPACK_IMPORTED_MODULE_7__.expandWithNestedArray)(t,e.rings[s]);break;case"multipoint":(0,_geometry_support_aaBoundingRect_js__WEBPACK_IMPORTED_MODULE_7__.expandWithNestedArray)(t,e.points);break;case"extent":t[0]=e.xmin,t[1]=e.ymin,t[2]=e.xmax,t[3]=e.ymax}}function L(e,s){(0,_core_maybe_js__WEBPACK_IMPORTED_MODULE_2__.isSome)(e)&&(J(e,U),(0,_geometry_support_aaBoundingRect_js__WEBPACK_IMPORTED_MODULE_7__.expand)(s,U,s))}function O(e,t){return null!=e.objectId?e.objectId:e.attributes&&t?e.attributes[t]:null}const P=(0,_geometry_support_aaBoundingBox_js__WEBPACK_IMPORTED_MODULE_6__.create)(),U=(0,_geometry_support_aaBoundingRect_js__WEBPACK_IMPORTED_MODULE_7__.create)();
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "DehydratedFeatureSetParserContext": () => (/* binding */ g)
/* harmony export */ });
/* harmony import */ var _core_compilerUtils_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../../core/compilerUtils.js */ 25618);
/* harmony import */ var _core_maybe_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../../core/maybe.js */ 18502);
/* harmony import */ var _core_uid_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../../core/uid.js */ 30145);
...
/* harmony import */ var _geometry_support_zscale_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../../geometry/support/zscale.js */ 3615);
/* harmony import */ var _layers_graphics_dehydratedFeatures_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../../../layers/graphics/dehydratedFeatures.js */ 43314);
...
/* harmony export */ });
/* harmony import */ var _rest_query_operations_pbfDehydratedFeatureSet_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../../rest/query/operations/pbfDehydratedFeatureSet.js */ 56930);
/* harmony import */ var _rest_query_operations_pbfQueryUtils_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../../rest/query/operations/pbfQueryUtils.js */ 56445);
/*
All material copyright ESRI, All Rights Reserved, unless otherwise specified.
See https://js.arcgis.com/4.22/esri/copyright.txt for details.
*/
class t{_parseFeatureQuery(t){const s=(0,_rest_query_operations_pbfQueryUtils_js__WEBPACK_IMPORTED_MODULE_1__.parsePBFFeatureQuery)(t.buffer,new _rest_query_operations_pbfDehydratedFeatureSet_js__WEBPACK_IMPORTED_MODULE_0__.DehydratedFeatureSetParserContext(t.options)),o={...s,spatialReference:s.spatialReference.toJSON(),fields:s.fields?s.fields.map((e=>e.toJSON())):void 0};return Promise.resolve(o)}}function s(){return new t}


/***/ })

}]);
//# sourceMappingURL=4704.3b9dfe0417b4ea951432.js.map