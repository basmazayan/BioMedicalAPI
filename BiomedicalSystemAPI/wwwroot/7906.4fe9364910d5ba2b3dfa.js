"use strict";
(self["webpackChunkbio_medical"] = self["webpackChunkbio_medical"] || []).push([[7906],{
...
See https://js.arcgis.com/4.22/esri/copyright.txt for details.
*/
function r(r,a,t){r.referencesGeometry();const n=a.readArcadeFeature();try{return r.evaluate({...t,$feature:n})}catch(o){return _core_Logger_js__WEBPACK_IMPORTED_MODULE_0__.default.getLogger("esri.views.2d.support.arcadeOnDemand").warn("Feature arcade evaluation failed:",o),null}}
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "FeatureStore2D": () => (/* binding */ l),
/* harmony export */   "featureAdapter": () => (/* binding */ u)
/* harmony export */ });
...
/* harmony import */ var _chunks_rbush_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../../../chunks/rbush.js */ 30928);
...
/* harmony import */ var _Store2D_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./Store2D.js */ 89271);
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "Store2D": () => (/* binding */ o)
/* harmony export */ });
...
/* harmony import */ var _core_accessorSupport_diffUtils_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../../../core/accessorSupport/diffUtils.js */ 58616);
...
/* harmony import */ var _arcade_callExpressionWithCursor_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../../arcade/callExpressionWithCursor.js */ 93021);
...
const c = __webpack_require__.e(/*! import() */ 3373).then(__webpack_require__.bind(__webpack_require__, /*! ../../../../layers/support/labelFormatUtils.js */ 73373));
...
class o {
  ...
  updateSchema(a, r) {
    ...
    return (0,D_biomedicalUpdates_biomediacl_UI_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__.default)(function* () {
      const c = (0,_core_accessorSupport_diffUtils_js__WEBPACK_IMPORTED_MODULE_3__.diff)(_this._schema, r);
      if (_this._schema = r, !r || (0,_core_maybe_js__WEBPACK_IMPORTED_MODULE_2__.isNone)(c) || !(0,_core_accessorSupport_diffUtils_js__WEBPACK_IMPORTED_MODULE_3__.hasDiff)(c, "attributes")) return;
      (0,_core_has_js__WEBPACK_IMPORTED_MODULE_1__.default)("esri-2d-update-debug") && console.debug("Applying Update - Store:", c), _this._bitsets.computed.clear(), a.targets[r.name] = !0;
      ...
      for (const e in o) {
        ...
        switch (s.type) {
          ...
          case "expression":
            n.push(_this._createArcadeComputedField(s));
            break;

          case "label-expression":
            n.push(_this._createLabelArcadeComputedField(s));
            break;
      ...
      _this._computedFields = yield Promise.all(n), _this._canCacheExpressionValue = !_this._computedFields.some(e => "expression" === e.type && e.expression.referencesScale()), _this._statisticFields = d;
    })();
  }
  ...
  _createArcadeComputedField(e) {
    ...
    return (0,D_biomedicalUpdates_biomediacl_UI_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__.default)(function* () {
      const s = _this2._sourceInfo.spatialReference,
            t = _this2._sourceInfo.fieldsIndex;
      return { ...e,
        expression: yield (0,_support_arcadeOnDemand_js__WEBPACK_IMPORTED_MODULE_4__.createRendererExpression)(e.valueExpression, s, t)
      };
    })();
  }
      ...
      case "expression":
        {
          ...
          return (0,_arcade_callExpressionWithCursor_js__WEBPACK_IMPORTED_MODULE_5__.default)(i, e, {
            $view: {
              scale: t
            }
          });
...
/* harmony export */ });
/* harmony import */ var _FeatureSetReader_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./FeatureSetReader.js */ 56738);
/*
All material copyright ESRI, All Rights Reserved, unless otherwise specified.
See https://js.arcgis.com/4.22/esri/copyright.txt for details.
*/
...
//# sourceMappingURL=7906.4fe9364910d5ba2b3dfa.js.map