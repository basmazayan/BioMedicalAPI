"use strict";
(self["webpackChunkbio_medical"] = self["webpackChunkbio_medical"] || []).push([[7485],{
...
/* harmony import */ var _core_typedArrayUtil_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../../core/typedArrayUtil.js */ 65218);
/* harmony import */ var _chunks_quat_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../../chunks/quat.js */ 3456);
/* harmony import */ var _chunks_quatf32_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../../chunks/quatf32.js */ 25833);
/* harmony import */ var _chunks_vec3_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../../chunks/vec3.js */ 63702);
/* harmony import */ var _chunks_vec3f32_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../../../chunks/vec3f32.js */ 30773);
/* harmony import */ var _geometry_projection_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../../../geometry/projection.js */ 15695);
...
/* harmony import */ var _i3s_PointCloudWorkerUtil_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./i3s/PointCloudWorkerUtil.js */ 54037);
/*
All material copyright ESRI, All Rights Reserved, unless otherwise specified.
See https://js.arcgis.com/4.22/esri/copyright.txt for details.
*/
class p{transform(e){const a=this._transform(e),o=[a.points.buffer,a.rgb.buffer];(0,_core_maybe_js__WEBPACK_IMPORTED_MODULE_0__.isSome)(a.pointIdFilterMap)&&o.push(a.pointIdFilterMap.buffer);for(const t of a.attributes)"buffer"in t.values&&(0,_core_typedArrayUtil_js__WEBPACK_IMPORTED_MODULE_1__.isArrayBuffer)(t.values.buffer)&&t.values.buffer!==a.rgb.buffer&&o.push(t.values.buffer);return Promise.resolve({result:a,transferList:o})}_transform(r){const e=(0,_i3s_PointCloudWorkerUtil_js__WEBPACK_IMPORTED_MODULE_8__.readGeometry)(r.schema,r.geometryBuffer);let a=e.length/3,o=null;const f=[],s=(0,_i3s_PointCloudWorkerUtil_js__WEBPACK_IMPORTED_MODULE_8__.getAttributeValues)(r.primaryAttributeData,e,a);(0,_core_maybe_js__WEBPACK_IMPORTED_MODULE_0__.isSome)(r.primaryAttributeData)&&s&&f.push({attributeInfo:r.primaryAttributeData.attributeInfo,values:s});const i=(0,_i3s_PointCloudWorkerUtil_js__WEBPACK_IMPORTED_MODULE_8__.getAttributeValues)(r.modulationAttributeData,e,a);(0,_core_maybe_js__WEBPACK_IMPORTED_MODULE_0__.isSome)(r.modulationAttributeData)&&i&&f.push({attributeInfo:r.modulationAttributeData.attributeInfo,values:i});let p=(0,_i3s_PointCloudWorkerUtil_js__WEBPACK_IMPORTED_MODULE_8__.evaluateRenderer)(r.rendererInfo,s,i,a);if(r.filterInfo&&r.filterInfo.length>0&&(0,_core_maybe_js__WEBPACK_IMPORTED_MODULE_0__.isSome)(r.filterAttributesData)){const t=r.filterAttributesData.map((t=>{const r=(0,_i3s_PointCloudWorkerUtil_js__WEBPACK_IMPORTED_MODULE_8__.getAttributeValues)(t,e,a),o={attributeInfo:t.attributeInfo,values:r};return f.push(o),o}));o=new Uint32Array(a),a=(0,_i3s_PointCloudWorkerUtil_js__WEBPACK_IMPORTED_MODULE_8__.filterInPlace)(e,p,o,r.filterInfo,t)}for(const t of r.userAttributesData){const r=(0,_i3s_PointCloudWorkerUtil_js__WEBPACK_IMPORTED_MODULE_8__.getAttributeValues)(t,e,a);f.push({attributeInfo:t.attributeInfo,values:r})}3*a<p.length&&(p=new Uint8Array(p.buffer.slice(0,3*a))),this._applyElevationOffsetInPlace(e,a,r.elevationOffset);const c=this._transformCoordinates(e,a,r.obb,_geometry_SpatialReference_js__WEBPACK_IMPORTED_MODULE_7__.default.fromJSON(r.inSR),_geometry_SpatialReference_js__WEBPACK_IMPORTED_MODULE_7__.default.fromJSON(r.outSR));return{obb:r.obb,points:c,rgb:p,attributes:f,pointIdFilterMap:o}}_transformCoordinates(t,r,a,n,u){if(!(0,_geometry_projection_js__WEBPACK_IMPORTED_MODULE_6__.projectBuffer)(t,n,0,t,u,0,r))throw Error("Can't reproject");const l=(0,_chunks_vec3f32_js__WEBPACK_IMPORTED_MODULE_5__.f)(a.center[0],a.center[1],a.center[2]),b=(0,_chunks_vec3f32_js__WEBPACK_IMPORTED_MODULE_5__.c)(),m=(0,_chunks_vec3f32_js__WEBPACK_IMPORTED_MODULE_5__.c)();(0,_chunks_quat_js__WEBPACK_IMPORTED_MODULE_2__.c)(c,a.quaternion);const p=new Float32Array(3*r);for(let e=0;e<r;e++)b[0]=t[3*e]-l[0],b[1]=t[3*e+1]-l[1],b[2]=t[3*e+2]-l[2],(0,_chunks_vec3_js__WEBPACK_IMPORTED_MODULE_4__.q)(m,b,c),a.halfSize[0]=Math.max(a.halfSize[0],Math.abs(m[0])),a.halfSize[1]=Math.max(a.halfSize[1],Math.abs(m[1])),a.halfSize[2]=Math.max(a.halfSize[2],Math.abs(m[2])),p[3*e]=b[0],p[3*e+1]=b[1],p[3*e+2]=b[2];return p}_applyElevationOffsetInPlace(t,r,e){if(0!==e)for(let a=0;a<r;a++)t[3*a+2]+=e}}const c=(0,_chunks_quatf32_js__WEBPACK_IMPORTED_MODULE_3__.b)();function h(){return new p}
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "createAttributeDataIndex": () => (/* binding */ l),
/* harmony export */   "createGeometryDescriptor": () => (/* binding */ g),
/* harmony export */   "createGeometryDescriptorForDraco": () => (/* binding */ v),
/* harmony export */   "createGeometryDescriptorFromDefinition": () => (/* binding */ d),
/* harmony export */   "createGeometryDescriptorFromSchema": () => (/* binding */ w),
/* harmony export */   "createGeometryIndexFromSchema": () => (/* binding */ y),
/* harmony export */   "createRawView": () => (/* binding */ f),
/* harmony export */   "createTypedView": () => (/* binding */ c),
/* harmony export */   "getBytesPerValue": () => (/* binding */ A),
/* harmony export */   "isValueType": () => (/* binding */ h),
/* harmony export */   "readBinaryAttribute": () => (/* binding */ C),
/* harmony export */   "readHeader": () => (/* binding */ a),
/* harmony export */   "readStringArray": () => (/* binding */ s),
/* harmony export */   "valueType2ArrayBufferReader": () => (/* binding */ I),
/* harmony export */   "valueType2TypedArrayClassMap": () => (/* binding */ m)
/* harmony export */ });
...
/* harmony export */ });
/* harmony import */ var _core_maybe_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../../../core/maybe.js */ 18502);
/* harmony import */ var _renderers_PointCloudClassBreaksRenderer_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../../../renderers/PointCloudClassBreaksRenderer.js */ 75460);
/* harmony import */ var _renderers_PointCloudStretchRenderer_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../../../renderers/PointCloudStretchRenderer.js */ 67886);
/* harmony import */ var _renderers_PointCloudUniqueValueRenderer_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../../../renderers/PointCloudUniqueValueRenderer.js */ 34357);
/* harmony import */ var _I3SBinaryReader_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./I3SBinaryReader.js */ 23870);
/* harmony import */ var _LEPCC_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./LEPCC.js */ 81345);
/*
All material copyright ESRI, All Rights Reserved, unless otherwise specified.
See https://js.arcgis.com/4.22/esri/copyright.txt for details.
*/
...
//# sourceMappingURL=7485.bb124fd708ea2eda9a3d.js.map