"use strict";
(self["webpackChunkbio_medical"] = self["webpackChunkbio_medical"] || []).push([[8805],{
...
/* harmony export */ });
/* harmony import */ var _webgl_Geometry_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../webgl/Geometry.js */ 74953);
/*
All material copyright ESRI, All Rights Reserved, unless otherwise specified.
See https://js.arcgis.com/4.22/esri/copyright.txt for details.
*/
...
/* harmony export */ });
/* harmony import */ var _MemoryBuffer_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./MemoryBuffer.js */ 74322);
/*
All material copyright ESRI, All Rights Reserved, unless otherwise specified.
See https://js.arcgis.com/4.22/esri/copyright.txt for details.
*/
...
/* harmony import */ var _geometry_libtess_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../../../geometry/libtess.js */ 2607);
/* harmony import */ var _Feature_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./Feature.js */ 6893);
/* harmony import */ var _IndexMemoryBuffer_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./IndexMemoryBuffer.js */ 2085);
/* harmony import */ var _SourceLayerData_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./SourceLayerData.js */ 53125);
/* harmony import */ var _VertexMemoryBuffer_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./VertexMemoryBuffer.js */ 65187);
/* harmony import */ var _buckets_CircleBucket_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./buckets/CircleBucket.js */ 61227);
/* harmony import */ var _buckets_FillBucket_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./buckets/FillBucket.js */ 60700);
/* harmony import */ var _buckets_LineBucket_js__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./buckets/LineBucket.js */ 84232);
/* harmony import */ var _buckets_SymbolBucket_js__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./buckets/SymbolBucket.js */ 10723);
/* harmony import */ var _webgl_TileClipper_js__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ../webgl/TileClipper.js */ 24145);
/* harmony import */ var _tiling_enums_js__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ../../tiling/enums.js */ 16379);
...
class w {
  constructor(t, r, s, i, o) {
    ...
    this._level = c;
    const a = k + Math.max((this._level - T) * g, 0);

    for (const u of Object.keys(t)) {
      const r = t[u];
      this._pbfTiles[u] = new _core_pbf_js__WEBPACK_IMPORTED_MODULE_1__.default(new Uint8Array(r.protobuff), new DataView(r.protobuff));
      ...
      if (r.refKey) {
        ...
        if (t > 0) {
          const e = (1 << t) - 1,
                r = n & e,
                s = l & e;
          this._tileClippers[u] = new _webgl_TileClipper_js__WEBPACK_IMPORTED_MODULE_12__.TileClipper(t, r, s, 8, a);
        }
      }

      this._tileClippers[u] || (this._tileClippers[u] = new _webgl_TileClipper_js__WEBPACK_IMPORTED_MODULE_12__.SimpleBuilder());
    }
  }
  ...
  parse(e) {
    ...
    return (0,D_biomedicalUpdates_biomediacl_UI_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__.default)(function* () {
      ...
      if (_this._tile.status === _tiling_enums_js__WEBPACK_IMPORTED_MODULE_13__.TileStatus.INVALID) return Promise.resolve([]);
      ...
      if (m) {
        ...
        if (t || (t = c[e.source] = new Set()), t.add(e.sourceLayer), e.refLayerId) a.set(e.uid, e.refLayerId);else {
          ...
          if (t) {
            ...
            r || (r = o[e.source] = {});
            let s = r[h];
            s || (s = r[h] = []), s.push(t), n.push(t), l[e.id] = t;
          }
        }
      }
    }
    ...
    for (let f = 0; f < a.length; f++) {
      ...
      for (; m.nextTag(2);) {
        const e = m.getMessage(),
              t = new _Feature_js__WEBPACK_IMPORTED_MODULE_4__.default(e, p);
        e.release();
        const r = t.values;
        ...
        case 3:
          {
            const e = s.getMessage(),
                  t = new _SourceLayerData_js__WEBPACK_IMPORTED_MODULE_6__.default(e);
  ...
  _createFillBucket(e) {
    return new _buckets_FillBucket_js__WEBPACK_IMPORTED_MODULE_9__.default(e, this._level, this._tile.getWorkerTileHandler().getSpriteItems(), new _VertexMemoryBuffer_js__WEBPACK_IMPORTED_MODULE_7__.FillVertexBuffer(e.fillMaterial.getStride()), new _IndexMemoryBuffer_js__WEBPACK_IMPORTED_MODULE_5__.TriangleIndexBuffer(), new _VertexMemoryBuffer_js__WEBPACK_IMPORTED_MODULE_7__.OutlineVertexBuffer(e.outlineMaterial.getStride()), new _IndexMemoryBuffer_js__WEBPACK_IMPORTED_MODULE_5__.TriangleIndexBuffer());
  }

  _createLineBucket(e) {
    return new _buckets_LineBucket_js__WEBPACK_IMPORTED_MODULE_10__.default(e, this._level, this._tile.getWorkerTileHandler().getSpriteItems(), new _VertexMemoryBuffer_js__WEBPACK_IMPORTED_MODULE_7__.LineVertexBuffer(e.lineMaterial.getStride()), new _IndexMemoryBuffer_js__WEBPACK_IMPORTED_MODULE_5__.TriangleIndexBuffer());
  }

  _createCircleBucket(e) {
    return new _buckets_CircleBucket_js__WEBPACK_IMPORTED_MODULE_8__.default(e, this._level, this._tile.getWorkerTileHandler().getSpriteItems(), new _VertexMemoryBuffer_js__WEBPACK_IMPORTED_MODULE_7__.CircleVertexBuffer(e.circleMaterial.getStride()), new _IndexMemoryBuffer_js__WEBPACK_IMPORTED_MODULE_5__.TriangleIndexBuffer());
  }

  _createSymbolBucket(e) {
    const t = this._tile;
    return new _buckets_SymbolBucket_js__WEBPACK_IMPORTED_MODULE_11__.default(e, this._level, new _VertexMemoryBuffer_js__WEBPACK_IMPORTED_MODULE_7__.SymbolVertexBuffer(e.iconMaterial.getStride()), new _IndexMemoryBuffer_js__WEBPACK_IMPORTED_MODULE_5__.TriangleIndexBuffer(), new _VertexMemoryBuffer_js__WEBPACK_IMPORTED_MODULE_7__.SymbolVertexBuffer(e.textMaterial.getStride()), new _IndexMemoryBuffer_js__WEBPACK_IMPORTED_MODULE_5__.TriangleIndexBuffer(), t.placementEngine, t.getWorkerTileHandler());
  }
...
/* harmony export */ });
/* harmony import */ var _GeometryUtils_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./GeometryUtils.js */ 14437);
/* harmony import */ var _MemoryBuffer_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./MemoryBuffer.js */ 74322);
/*
All material copyright ESRI, All Rights Reserved, unless otherwise specified.
See https://js.arcgis.com/4.22/esri/copyright.txt for details.
*/
...
/* harmony import */ var _core_promiseUtils_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../../../core/promiseUtils.js */ 7808);
/* harmony import */ var _Placement_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./Placement.js */ 38884);
/* harmony import */ var _TileParser_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./TileParser.js */ 42571);
/* harmony import */ var _tiling_enums_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../../tiling/enums.js */ 16379);
...
class a {
  constructor(e, t, r, a) {
    this.status = _tiling_enums_js__WEBPACK_IMPORTED_MODULE_5__.TileStatus.INITIALIZED, this.placementEngine = new _Placement_js__WEBPACK_IMPORTED_MODULE_3__.PlacementEngine(), this.tileKey = e, this.refKeys = t, this._workerTileHandler = r, this._styleRepository = a;
  }

  release() {
    this.tileKey = "", this.refKeys = null, this.status = _tiling_enums_js__WEBPACK_IMPORTED_MODULE_5__.TileStatus.INITIALIZED, this._workerTileHandler = null;
  }
  ...
  parse(s, r, a) {
    ...
    return (0,D_biomedicalUpdates_biomediacl_UI_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__.default)(function* () {
      ...
      if ((0,_core_maybe_js__WEBPACK_IMPORTED_MODULE_1__.isSome)(n)) {
        const e = () => {
          n.removeEventListener("abort", e), _this.status = _tiling_enums_js__WEBPACK_IMPORTED_MODULE_5__.TileStatus.INVALID;
        };
      ...
      try {
        o = yield _this._parse(s, a);
      } catch (h) {
        if ((0,_core_promiseUtils_js__WEBPACK_IMPORTED_MODULE_2__.isAbortError)(h)) throw h;
        return {
          result: [],
          transferList: []
        };
      ...
      _this.status = _tiling_enums_js__WEBPACK_IMPORTED_MODULE_5__.TileStatus.READY;
      const l = [];
  ...
  setObsolete() {
    this.status = _tiling_enums_js__WEBPACK_IMPORTED_MODULE_5__.TileStatus.INVALID;
  }
  ...
  _parse(e, t) {
    ...
    return (0,D_biomedicalUpdates_biomediacl_UI_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__.default)(function* () {
      ...
      _this2.status = _tiling_enums_js__WEBPACK_IMPORTED_MODULE_5__.TileStatus.MODIFIED;
      return new _TileParser_js__WEBPACK_IMPORTED_MODULE_4__.default(s, _this2, t.client, _this2._styleRepository, e.styleLayerUIDs).parse(t);
    })();
  }
...
/* harmony import */ var _WorkerTile_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./WorkerTile.js */ 93251);
/* harmony import */ var _style_StyleRepository_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./style/StyleRepository.js */ 48955);
...
class r {
  ...
  createTileAndParse(s, r) {
    ...
    return (0,D_biomedicalUpdates_biomediacl_UI_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__.default)(function* () {
      ...
      const n = new _WorkerTile_js__WEBPACK_IMPORTED_MODULE_2__.default(o, i, _this, _this._styleRepository);

      try {
        return yield n.parse(s, _this._vectorTileLayerMaxBuffers, r);
      } catch (l) {
  ...
  setStyle(e) {
    this._styleRepository = new _style_StyleRepository_js__WEBPACK_IMPORTED_MODULE_3__.default(e.style), this._spriteInfo = {}, this._glyphInfo = {}, this._vectorTileLayerMaxBuffers = e.vectorTileLayerMaxBuffers;
  }
...
/* harmony export */   "default": () => (/* binding */ t)
/* harmony export */ });
/* harmony import */ var _BaseBucket_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./BaseBucket.js */ 42512);
/*
All material copyright ESRI, All Rights Reserved, unless otherwise specified.
See https://js.arcgis.com/4.22/esri/copyright.txt for details.
*/
...
/* harmony export */ });
/* harmony import */ var _core_ArrayPool_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../../../../core/ArrayPool.js */ 61684);
...
/* harmony export */ });
/* harmony import */ var _BaseBucket_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./BaseBucket.js */ 42512);
/* harmony import */ var _webgl_TurboLine_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../webgl/TurboLine.js */ 63537);
/*
All material copyright ESRI, All Rights Reserved, unless otherwise specified.
See https://js.arcgis.com/4.22/esri/copyright.txt for details.
*/
...
//# sourceMappingURL=8805.995e642449bdbbc6c876.js.map